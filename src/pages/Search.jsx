    ...
    return (
        <div className="search">
            <div className="search__back">
                ...
                <path d="M7 13L1 7L7 1" stroke="#F2F2F2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <span className="search__back-text">Назад</span>
            </div>
            <div className="search__content">
                <div className="search__content-head">
                    ...
                    <path d="M12 6V1" stroke="#EB752B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M20 19V14" stroke="#EB752B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M20 10V1" stroke="#EB752B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
